This website was Built with React.js using json-server on the backend to Get, Post, Updat and Delete data and show it on Client side as well in the form of list.
